...
export const Hero = () => {
  return (
    <div className="bg-black h-screen  text-white flex p-36">
        <div className="font-extrabold text-[100px] font-sans w-[500px] bg-clip-text text-transparent bg-gradient-to-t from-[#30A0F1] to-[#7EF6BC]">
        WHAT DID YOU SEE?
        </div>
        <div>
            Let’s keep track of  our dreams
        </div>
        <div class="grid grid-cols-3 w-[500px] gap-3 ">
